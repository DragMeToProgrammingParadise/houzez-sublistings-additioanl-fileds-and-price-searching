    ...
    $fields = array(
        ...
        array(
            ...
            'fields' => array(
                ...
                array(
                    'type'   => 'heading',
                    'name'   => houzez_option('cl_payment_plans', 'Payment Plans'),
                    'columns' => 12,
                ),
                array(
                    'id'     => "{$houzez_prefix}mu_payment_plans",
                    'type'   => 'group',
                    'clone'  => true, // Allow multiple payment plans
                    'sort_clone' => false,
                    'fields' => array(
                        array(
                            'name' => houzez_option('cl_payment_title', 'Payment Plan Title'),
                            'id'   => "payment_title",
                            'type' => 'text',
                            'placeholder' => houzez_option('cl_payment_title_plac', 'Enter Payment Plan Title'),
                            'columns' => 12,
                        ),
                        array(
                            'name' => houzez_option('cl_payment_value', 'Payment Plan Value'),
                            'id'   => "payment_value",
                            'type' => 'text',
                            'placeholder' => houzez_option('cl_payment_value_plac', 'Enter Payment Plan Value'),
                            'columns' => 12,
                        ),
                    ),
                ),
